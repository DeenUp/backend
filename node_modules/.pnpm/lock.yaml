...
packages:
  ...
  /enforce-branch-name@1.1.2:
    resolution: {integrity: sha512-6aJAN+77gBV+/Ne+ozZ+5j61pzqqyITI1eBa6gEmoeVJo6xUjCmUcHQTfkzK+TVYGcE/kG1abkoL3OoLR8F6cw==}
    hasBin: true
    dependencies:
      current-git-branch: 1.1.0
      get-them-args: 1.3.2
  ...
  /pnpm@9.0.6:
    resolution: {integrity: sha512-9thjEwlzIHy3ozbWtDmiQqJqyAaAd99TDWqGBpQZhT3B/+ZAKexZSpxQWjpBDRlkPIcKumd2Mw9c/dzxCpwWFw==}
    engines: {node: '>=18.12'}
    hasBin: true
    dev: true
